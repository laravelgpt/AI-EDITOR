...
class OpenRouterProvider implements AiProviderInterface
{
    ...
    {
        $this->apiKey = config('ai-text-editor.ai.providers.openrouter.api_key');
        $this->model = config('ai-text-editor.ai.providers.openrouter.model');
        $this->baseUrl = config('ai-text-editor.ai.providers.openrouter.base_url');
    }
