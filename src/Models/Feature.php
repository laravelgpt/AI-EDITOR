...
namespace LaravelDynamicStarterKit\Advanced\Models;
...
class Feature extends Model
{
    ...
    {
        $categories = config('advanced-starter-kit.feature_categories', []);
    ...
    public function getControllerConfiguration(): array
    {
        return [
            ...
            'api_methods' => ['apiIndex', 'apiShow', 'apiStore', 'apiUpdate', 'apiDestroy'],
        ];
    }
