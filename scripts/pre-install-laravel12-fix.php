...
/**
 * Pre-Installation Laravel 12 Fix Script
 * 
 * This script should be run BEFORE installing the package to fix Laravel 12 compatibility issues
 */

echo "🔧 AI Text Editor - Pre-Installation Laravel 12 Fix\n";
echo "==================================================\n\n";
...
$artisanBackup = __DIR__ . '/../artisan.backup';
$bootstrapBackup = __DIR__ . '/../bootstrap/app.php.backup';

if (file_exists(__DIR__ . '/../artisan')) {
    copy(__DIR__ . '/../artisan', $artisanBackup);
    echo "✅ Backed up original artisan file\n";
}

if (file_exists(__DIR__ . '/../bootstrap/app.php')) {
    copy(__DIR__ . '/../bootstrap/app.php', $bootstrapBackup);
    echo "✅ Backed up original bootstrap/app.php file\n";
}
...
echo "\nNow you can safely install the AI Text Editor package:\n";
echo "composer require ai-editor/ai-text-editor\n";
echo "\nBackup files are saved as:\n";
echo "- artisan.backup\n";
echo "- bootstrap/app.php.backup\n";
